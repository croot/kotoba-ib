...
define('ERR_USERNOTEXIST', '(Ошибка) Пользователя с таким ключевым словом не существует или он не входит ни в одну группу.');
...
define('ERR_STYLESHEETS_NOT_EXIST', '(Ошибка) Не задан ни один стиль оформления.');
define('ERR_LANGUAGES_NOT_EXIST', '(Ошибка) Не задан ни один язык.');

/*************************************
 * Ошибки формата для входных данных *
 *************************************/

define('ERR_KEYWORD', '(Ошибка) Длина ключего слова должна быть от 16 до 32 символов, допустимые значения: A-Za-z0-9_-.');
define('ERR_THREADSPERPAGE', '(Ошибка) Число нитей на странице предпросмотра доски должно быть в пределах ' . KOTOBA_MIN_THREADSPERPAGE . '-' . KOTOBA_MAX_THREADSPERPAGE .'.');
define('ERR_POSTSPERTHREAD', '(Ошибка) Число сообщений в треде на странице предпросмотра доски должно быть в пределах ' . KOTOBA_MIN_POSTSPERTHREAD . '-' . KOTOBA_MAX_POSTSPERTHREAD . '.');
define('ERR_LINESPERPOST', '(Ошибка) Число строк в сообщении на странице предпросмотра доски должно быть в пределах ' . KOTOBA_MIN_LINESPERPOST . '-' . KOTOBA_MAX_LINESPERPOST . '.');
define('ERR_STYLESHEET', '(Ошибка) Прекрасно, что вы умеете писать скрипты, но выберите стиль оформления из списка.');
define('ERR_LANGUAGE', '(Ошибка) Прекрасно, что вы умеете писать скрипты, но выберите язык из списка.');

/*****************************************
 * Ошибки обмена данными с базой данных. *
 *****************************************/

define('ERR_SAVEUSERSETTINGS', '(Ошибка) Не удалось сохранить настройки пользователя.');
