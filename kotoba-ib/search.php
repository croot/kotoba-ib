...
try {
    ...
    $password = !isset($_SESSION['password']) || $_SESSION['password'] === null ? '' : $_SESSION['password'];
    /*
    ...
    $threads = threads_search_visible_by_board($board['id'], $page, $_SESSION['user'],
    $_SESSION['threads_per_page'], $_POST['search']);
