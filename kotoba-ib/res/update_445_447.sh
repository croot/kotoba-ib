...
NEW_DIR="$CSS_DIR/kotoba.css"
NEW_FILES="$NEW_DIR/favorites.png \
           $NEW_DIR/delete.png \
           $NEW_DIR/kotoba.css \
           $NEW_DIR/delfile.png \
           $NEW_DIR/sticky.png \
...
#
echo "Add files."
execute "mkdir $ABS_PATH/$NEW_DIR" "`basename $0`:$LINENO"
execute "chown $APACHE_UG $ABS_PATH/$NEW_DIR" "`basename $0`:$LINENO"
execute "chmod $RWX $ABS_PATH/$NEW_DIR" "`basename $0`:$LINENO"
