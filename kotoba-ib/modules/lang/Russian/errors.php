...
NodataException::$messages['CATEGORY_ID_NOT_SPECIFED'] = 'Не задан идентификатор категории.';
NodataException::$messages['POPDOWN_HANDLER_ID_NOT_SPECIFED'] = 'Не задан идентификатор обработчика удаления нитей.';
NodataException::$messages['BOARD_SAME_UPLOAD_NOT_SPECIFED'] = 'Не задано название политики загрузки одинаковых файлов.';
...
FormatException::$messages['THREAD_SAGE'] = 'Флаг поднятия нити при ответе имеет не верный формат.';
FormatException::$messages['THREAD_WITH_IMAGES'] = 'Флаг прикрепления файлов к ответам в нить имеет не верный формат.';
