...
// TODO Исправить имена всех входящих параметров во всех скриптах в соотвествии с договорённостью.
// TODO Если пост удаляется спустя несколько секунд после создания, то это всего скорей бот и надо банить.
require 'config.php';
