...
FormatException::$messages['USER_KEYWORD'] = 'Длина ключего слова должна быть от 3 до 32 символов, допустимые значения: латинские буквы, цифры, нижнее подчеркивание и дефис.';
