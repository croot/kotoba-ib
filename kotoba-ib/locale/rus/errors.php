...
NodataException::$messages['REQUEST_METHOD'] = 'Не задан или не ожидаемый метод запроса данных.';
...
LimitException::$messages['WORD_TOO_LONG'] = 'Слово для фильтрации слишком длинное.'
?>
