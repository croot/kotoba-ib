...
Session expire in: {$sess.expire / 60 - intval(($sess.curtime - $settings.kotoba_session_start_time) / 360)}:{$sess.expire - intval(($sess.curtime - $settings.kotoba_session_start_time) / 60)} /
{$sess.expire / 60}:{$sess.expire} minutes.<br>
<br/>
