...
{if !$board.force_anonymous}
    <tr valign="top"><td class="postblock">Имя: </td><td><input type="text" name="name" size="28" maxlength="75" accesskey="n" value="{$name}"></td></tr>
{/if}
    ...
    <tr valign="top"><td class="postblock">Тема: </td><td><input type="text" name="subject" size="35" maxlength="75" accesskey="s"> <input type="submit" value="Ответить"></td></tr>
    <tr valign="top"><td class="postblock">Сообщение: </td><td><textarea name="text" cols="48" rows="4" accesskey="m">{if isset($quote)}>>{$quote}{/if}</textarea><img id="resizer" src="{$DIR_PATH}/flower.png"></td></tr>
