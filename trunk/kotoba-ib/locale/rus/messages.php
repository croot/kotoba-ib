...
$_['Input params.']['rus'] = 'Входные параметры.';
...
$_['Name too long.']['rus'] = 'Имя отправителя слишком длинное.';
...
$_['Requied parameter %s not set.']['rus'] = 'Необходимый параметр %s не передан.';
