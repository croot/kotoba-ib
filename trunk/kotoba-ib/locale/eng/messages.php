...
$_['Arrays and Objects what not implements __toString() method, cannot be cast to string. See description to strval() function.']['eng'] = 'Arrays and Objects what not implements __toString() method, cannot be cast to string. See description to strval() function.';
$_['Ban reason has wrong format.']['eng'] = 'Ban reason has wrong format.';
$_['Bans.']['eng'] = 'Bans.';
$_['Begining of IP-address range has wrong format.']['eng'] = 'Begining of IP-address range has wrong format.';
$_['Board id=%d not found.']['eng'] = 'Board id=%d not found.';
$_['Board name has wrong format. Board name must be string length at 1 to 16 symbols. Symbols can be latin letters and digits.']['eng'] = 'Board name has wrong format. Board name must be string length at 1 to 16 symbols. Symbols can be latin letters and digits.';
...
$_['Boards.']['eng'] = 'Boards.';
$_['Bump limit must be digit greater than zero.']['eng'] = 'Bump limit must be digit greater than zero.';
...
$_['Category name wrong format.']['eng'] = 'Category name wrong format.';
$_['Categories.']['eng'] = 'Categories.';
...
$_['Count of lines per post must be in range %d-%d.']['eng'] = 'Count of lines per post must be in range %d-%d.';
$_['Count of posts per thread must be in range %d-%d.']['eng'] = 'Count of posts per thread must be in range %d-%d.';
$_['Count of threads per page must be in range %d-%d.']['eng'] = 'Count of threads per page must be in range %d-%d.';
$_['Database error.']['eng'] = 'Database error.';
$_['End of IP-address range has wrong format.']['eng'] = 'End of IP-address range has wrong format.';
$_['Error in database: %s.']['eng'] = 'Error in database: %s.';
$_['Extension has wrong format.']['eng'] = 'Extension has wrong format.';
...
$_['Group name wrong format.']['eng'] = 'Group name wrong format.';
$_['Groups.']['eng'] = 'Groups.';
$_['Guest.']['eng'] = 'Guest.';
$_['Guests cannot do that.']['eng'] = 'Guests cannot do that.';
$_['ISO_639-2 code wrong format.']['eng'] = 'ISO_639-2 code wrong format.';
...
$_['Macrochan.']['eng'] = 'Macrochan.';
$_['Macrochan tag name wrong format or not exist.']['eng'] = 'Macrochan tag name wrong format or not exist.';
$_['Message detected as spam.']['eng'] = 'Message detected as spam.';
$_['Moderator.']['eng'] = 'Moderator.';
$_['Name too long.']['eng'] = 'Name too long.';
...
$_['Object cannot be cast to intger. See description to intval() function.']['eng'] = 'Object cannot be cast to intger. See description to intval() function.';
...
$_['Pages.']['eng'] = 'Pages.';
$_['Password wrong format. Password must be at 1 to 12 symbols length. Valid symbold is digits and latin letters.']['eng'] = 'Password wrong format. Password must be at 1 to 12 symbols length. Valid symbold is digits and latin letters.';
$_['Popdown handler name wrong format.']['eng'] = 'Popdown handler name wrong format.';
...
$_['Spam.']['eng'] = 'Spam.';
$_['Spamfilter.']['eng'] = 'Spamfilter.';
$_['Stored extension has wrong format.']['eng'] = 'Stored extension has wrong format.';
$_['Stylesheet id=%d not exist.']['eng'] = 'Stylesheet id=%d not exist.';
$_['Stylesheet name wrong format.']['eng'] = 'Stylesheet name wrong format.';
...
$_['Thumbnail name for nonimage files has wrong format.']['eng'] = 'Thumbnail name for nonimage files has wrong format.';
$_['Unicode.']['eng'] = 'Unicode.';
$_['Unknown upload type.']['eng'] = 'Unknown upload type.';
$_['Upload handler function name has a wrong format.']['eng'] = 'Upload handler function name has a wrong format.';
$_['Upload handlers.']['eng'] = 'Upload handlers.';
...
$_['Upload policy from same files wrong format. It must be string at 1 to 32 latin letters.']['eng'] = 'Upload policy from same files wrong format. It must be string at 1 to 32 latin letters.';
$_['Upload types.']['eng'] = 'Upload types.';
...
$_['Wrong spamfilter pattern.']['eng'] = 'Wrong spamfilter pattern.';
