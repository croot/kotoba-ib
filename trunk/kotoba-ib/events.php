...
define('ERR_BOARD_NOT_FOUND', '(Ошибка) Доски с именем %s не существует.');	// 1. Имя доски.
define('ERR_BOARD_EXIST_CHECK', '(Ошибка) Не удалось проверить существание доски с именем %s. Прична: %s.');	// 1. Имя доски. 2. Причина неудачи проверки существания доски.
define('ERR_BOARDS_NOT_EXIST', '(Ошибка) Не создано ни одной доски.');
define('ERR_BOARDS_LIST', '(Ошибка) Невозможно получить список досок. Причина: %s');	// 1. Причина неудачи получения списка досок.
