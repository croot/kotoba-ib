...
{if !$board.force_anonymous}
    <tr><td class="postblock">Name: </td><td><input type="text" name="name" size="28" maxlength="75" accesskey="n" value="{$name}"></td></tr>
{/if}
{if $enable_captcha}
...
{if $enable_macro}
    <tr><td class="postblock">Macro: </td>
    <td>
...
{/if}
    <tr><td class="postblock">Password: </td><td><input type="password" name="password" size="30" value="{$password}"></td></tr>
