...
{else}    <!-- Captcha disabled -->{/if}
    ...
    <tr><td class="postblock">Сообщение: </td><td><textarea name="text" cols="48" rows="4" accesskey="m">{if isset($quote)}>>{$quote}{/if}</textarea><img id="resizer" src="{$DIR_PATH}/flower.png"></td></tr>
